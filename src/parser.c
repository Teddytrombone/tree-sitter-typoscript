...
enum {
  ...
  aux_sym_modifier_parameters_repeat1 = 75,
  aux_sym_modifier_parameter_repeat1 = 76,
  aux_sym_string_repeat1 = 77,
  aux_sym_string_repeat2 = 78,
  anon_alias_sym_bracket_parameter = 79,
  alias_sym_condition_attribute = 80,
  alias_sym_copy_identifier = 81,
  anon_alias_sym_function = 82,
  alias_sym_reference_identifier = 83,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [24] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_typoscript_repeat1, 2), SHIFT_REPEAT(105),
  [27] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_typoscript_repeat1, 2), SHIFT_REPEAT(31),
  [30] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_typoscript_repeat1, 2), SHIFT_REPEAT(80),
  [33] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_typoscript_repeat1, 2), SHIFT_REPEAT(111),
  [36] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_typoscript_repeat1, 2), SHIFT_REPEAT(47),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_typoscript_repeat1, 2), SHIFT_REPEAT(90),
  ...
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_condition_block_repeat1, 2), SHIFT_REPEAT(105),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_condition_block_repeat1, 2),
  [56] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_condition_block_repeat1, 2), SHIFT_REPEAT(47),
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_condition_block_repeat1, 2), SHIFT_REPEAT(90),
  ...
  [90] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__condition_inner, 2), SHIFT_REPEAT(45),
  [93] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__condition_inner, 2), SHIFT_REPEAT(17),
  [96] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__condition_inner, 2),
  [98] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__condition_inner, 2), SHIFT_REPEAT(10),
  [101] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__condition_inner, 2), SHIFT_REPEAT(114),
  ...
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference_line, 4, .production_id = 4),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_reference_line, 4, .production_id = 4),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_copy_line, 4, .production_id = 3),
  [124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_copy_line, 4, .production_id = 3),
  [126] = {.entry = {.count = 1, .reusable = false}}, SHIFT(9),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3, .production_id = 5),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 3, .production_id = 5),
  ...
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_deletion_line, 4),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_deletion_line, 4),
  ...
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_modification_line, 6),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_modification_line, 6),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_legacy, 7),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_legacy, 7),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_configuration_block, 2),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_configuration_block, 2),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_line, 3),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment_line, 3),
  ...
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import, 2),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import, 2),
  ...
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__condition_line, 2),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__condition_line, 2),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_end, 2),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_end, 2),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__condition_line, 3),
  [192] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__condition_line, 3),
  ...
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__condition_segment, 1),
  [206] = {.entry = {.count = 1, .reusable = true}}, SHIFT(72),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__condition_inner, 1, .production_id = 1),
  ...
  [218] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition, 3),
  [220] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_modifier_parameter_repeat1, 2), SHIFT_REPEAT(129),
  [223] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_modifier_parameter_repeat1, 2), SHIFT_REPEAT(38),
  [226] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_modifier_parameter_repeat1, 2),
  [228] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_modifier_parameter_repeat1, 2), SHIFT_REPEAT(40),
  [231] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_modifier_parameter, 1),
  ...
  [241] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_constant, 3),
  [243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 3),
  [245] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_condition_bool, 1),
  ...
  [261] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__condition_line_repeat1, 2),
  [263] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__condition_line_repeat1, 2), SHIFT_REPEAT(31),
  ...
  [272] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_modifier_parameters, 3),
  ...
  [296] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_multiline_value_repeat1, 2), SHIFT_REPEAT(128),
  [299] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_multiline_value_repeat1, 2), SHIFT_REPEAT(58),
  [302] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_multiline_value_repeat1, 2),
  [304] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_modifier_parameter_repeat1, 1, .production_id = 6),
  [306] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_modifier_parameters, 4),
  [308] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(127),
  [311] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat2, 2),
  [313] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(63),
  [316] = {.entry = {.count = 1, .reusable = false}}, SHIFT(58),
  [318] = {.entry = {.count = 1, .reusable = false}}, SHIFT(102),
  [320] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_value_repeat1, 2),
  [322] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_value_repeat1, 2), SHIFT_REPEAT(125),
  [325] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_value_repeat1, 2), SHIFT_REPEAT(65),
  [328] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_modifier_parameters, 2),
  [330] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(126),
  [333] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2),
  [335] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(67),
  ...
  [358] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__condition_segment, 2),
  [360] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [362] = {.entry = {.count = 1, .reusable = true}}, SHIFT(99),
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_modifier_parameters, 4),
  [366] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [368] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_else, 1),
  [372] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_modifier_parameters, 2),
  [374] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [376] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [378] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_modifier_parameters, 3),
  ...
  [390] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_modifier_parameters_repeat1, 2),
  [392] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_modifier_parameters_repeat1, 2), SHIFT_REPEAT(48),
  ...
  [409] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multiline_value, 3),
  ...
  [417] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multiline_value, 2),
